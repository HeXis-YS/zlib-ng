...
#define MOZ_Z_deflateInit(strm, level) deflateInit_((strm), (level), ZLIB_VERSION, (int)sizeof(z_stream))
#define MOZ_Z_inflateInit(strm) inflateInit_((strm), ZLIB_VERSION, (int)sizeof(z_stream))
#define MOZ_Z_deflateInit2(strm, level, method, windowBits, memLevel, strategy) \
        deflateInit2_((strm), (level), (method), (windowBits), (memLevel), \
                     (strategy), ZLIB_VERSION, (int)sizeof(z_stream))
#define MOZ_Z_inflateInit2(strm, windowBits) inflateInit2_((strm), (windowBits), ZLIB_VERSION, (int)sizeof(z_stream))
#define MOZ_Z_inflateBackInit(strm, windowBits, window) \
...
#  define MOZ_Z_gzgetc(g) ((g)->have ? ((g)->have--, (g)->pos++, *((g)->next)++) : (MOZ_Z_gzgetc)(g))
...
#    define MOZ_Z_gzopen MOZ_Z_gzopen64
#    define MOZ_Z_gzseek MOZ_Z_gzseek64
#    define MOZ_Z_gztell MOZ_Z_gztell64
#    define MOZ_Z_gzoffset MOZ_Z_gzoffset64
#    define MOZ_Z_adler32_combine MOZ_Z_adler32_combine64
#    define MOZ_Z_crc32_combine MOZ_Z_crc32_combine64
#    define MOZ_Z_crc32_combine_gen MOZ_Z_crc32_combine_gen64
#  ifndef Z_LARGE64
     Z_EXTERN gzFile Z_EXPORT MOZ_Z_gzopen64(const char *, const char *);
     Z_EXTERN z_off_t Z_EXPORT MOZ_Z_gzseek64(gzFile, z_off_t, int);
     Z_EXTERN z_off_t Z_EXPORT MOZ_Z_gztell64(gzFile);
     Z_EXTERN z_off_t Z_EXPORT MOZ_Z_gzoffset64(gzFile);
     Z_EXTERN unsigned long Z_EXPORT MOZ_Z_adler32_combine64(unsigned long, unsigned long, z_off_t);
     Z_EXTERN unsigned long Z_EXPORT MOZ_Z_crc32_combine64(unsigned long, unsigned long, z_off_t);
     Z_EXTERN unsigned long Z_EXPORT MOZ_Z_crc32_combine_gen64(z_off64_t);
#  endif
#else
#  ifndef Z_SOLO
   Z_EXTERN gzFile Z_EXPORT MOZ_Z_gzopen(const char *, const char *);
   Z_EXTERN z_off_t Z_EXPORT MOZ_Z_gzseek(gzFile, z_off_t, int);
   Z_EXTERN z_off_t Z_EXPORT MOZ_Z_gztell(gzFile);
   Z_EXTERN z_off_t Z_EXPORT MOZ_Z_gzoffset(gzFile);
#  endif
   Z_EXTERN unsigned long Z_EXPORT MOZ_Z_adler32_combine(unsigned long, unsigned long, z_off_t);
   Z_EXTERN unsigned long Z_EXPORT MOZ_Z_crc32_combine(unsigned long, unsigned long, z_off_t);
   Z_EXTERN unsigned long Z_EXPORT MOZ_Z_crc32_combine_gen(z_off_t);
#endif
